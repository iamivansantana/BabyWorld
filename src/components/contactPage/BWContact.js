                ...
                <div className="contactContainer">
                    ...
                    <div className="grid-contact-container">
                        <div className="contactPicture">
                            <img src="assets\BW-Resources\team.jpg" alt="TeamPicture" />
                        </div>
                        <div className="contactText">
                            <p>Desde la noticia de la llegada de un nuevo integrante de la familia, las primeras etapas de crecimiento y desarrollo del bebé, una enorme responsabilidad nos acobija que como padres debemos sobrellevar.</p>
